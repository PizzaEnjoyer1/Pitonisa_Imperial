...
def analizar_destino_maya(nombre):
    ...
    \nSin embargo, no estarás solo: {aliados.get(consonantes, "fuerzas místicas te acompañarán")}. Los oráculos binarios han revelado que {elemento}. Este destino se manifestará {tiempos[ciclo_lunar]}. {intensidades[intensidad]}.{impactos[len(nombre) > 6]} Y así está escrito: {legado}.
    """
